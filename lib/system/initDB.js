...
function initDB(m, client) {
  ...
  settings.banner ??= 'https://bot.stellarwa.xyz/files/lTg2Z.jpeg'
  settings.icon ??= 'https://bot.stellarwa.xyz/files/bdXVE.jpeg'
  settings.currency ??= 'Coins'
  settings.namebot ??= 'Bocchi Hitori'
  settings.namebot2 ??= 'Bocchi'
