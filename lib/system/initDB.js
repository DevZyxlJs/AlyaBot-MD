...
function initDB(m, client) {
  ...
  settings.banner ??= 'https://cdn.nexylight.xyz/files/aouhio5v.jpeg'
  settings.icon ??= 'https://cdn.nexylight.xyz/files/9yhtos.jpeg'
  settings.currency ??= '¥enes'
  settings.namebot ??= 'Kana Arima'
  settings.namebot2 ??= 'Kana'
